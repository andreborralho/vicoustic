	...
	<form action="<?php echo JRoute::_('index.php?option=com_product_filter&view=productfilters'); ?>" method="post" name="filter_doors" id="filter_doors">
		...
		<div id="filter_doors_form" class="filter_form">
			...
			<div id="filter_doors_number_doors" class="filter_form_content doors_filter_form_content">
				...
				<?php if(isset($_POST['doors_1door']) && $_POST['doors_1door'] == 2): ?>
				...
				<?php if(isset($_POST['doors_2doors']) && $_POST['doors_2doors'] == 2): ?>
			...
			<div id="filter_doors_finish" class="filter_form_content doors_filter_form_content">
				...
				<?php if(isset($_POST['doors_wood']) && $_POST['doors_wood'] == 2): ?>
				...
				<?php if(isset($_POST['doors_steel']) && $_POST['doors_steel'] == 2): ?>
	...
	<form action="<?php echo JRoute::_('index.php?option=com_product_filter&view=productfilters'); ?>" method="post" name="filter_antivibratics" id="filter_antivibratics">
		...
		<div id="filter_antivibratics_form" class="filter_form">
			...
			<div id="filter_antivibratics_installation" class="filter_form_content">
				...
				<?php if(isset($_POST['antivibratics_wall']) && $_POST['antivibratics_wall'] == 2): ?>
				...
				<?php if(isset($_POST['antivibratics_ceiling']) && $_POST['antivibratics_ceiling'] == 2): ?>
				...
				<?php if(isset($_POST['antivibratics_floor']) && $_POST['antivibratics_floor'] == 2): ?>
				...
				<?php if(isset($_POST['antivibratics_division_wall']) && $_POST['antivibratics_division_wall'] == 2): ?>
			...
			<div class="filter_form_content">
				...
				<select name="antivibratics_load_weight">
					...
					<?php for ($i=0; $i <= sizeof($load_weight_list)-1; $i++): ?>
						<?php if(isset($_POST['antivibratics_load_weight']) && $_POST['antivibratics_load_weight'] == $load_weight_max_list[$i]): ?>
				...
				<select name="antivibratics_mounting_width">
					...
					<?php foreach ($mounting_width_list as $mounting_width) :?>
						...
						<?php if(isset($_POST['antivibratics_mounting_width']) && $_POST['antivibratics_mounting_width'] == $mounting_width): ?>
				...
				<div id="filter_blankets_rw_dropdown" class="filter_form_dropdown">Rw<br>
					...
					<select name="blankets_rw">
						...
						<?php foreach ($blankets_rw_list as $rw): ?>
							<?php if(isset($_POST['blankets_rw']) && $_POST['blankets_rw'] == $rw): ?>
								<option value="<?php echo $rw; ?>" selected><?php echo $rw; ?> dB</option>
							<?php else: ?>
								<option value="<?php echo $rw; ?>"><?php echo $rw; ?> dB</option>
							<?php endif; ?>
	...
	<form action="<?php echo JRoute::_('index.php?option=com_product_filter&view=productfilters'); ?>" method="post" name="filter_panels" id="filter_panels">
		...
		<div id="filter_panels_form" class="filter_form">
			...
			<div id="filter_panels_functionality" class="filter_form_content">
				...
				<?php if(isset($_POST['panels_absorption']) && $_POST['panels_absorption'] == 2): ?>
				...
				<?php if(isset($_POST['panels_diffusion']) && $_POST['panels_diffusion'] == 2): ?>
				...
				<?php if(isset($_POST['panels_basstrap']) && $_POST['panels_basstrap'] == 2): ?>
			...
			<div id="filter_panels_absorption_frequencies" class="filter_form_content">
				...
				<?php if(isset($_POST['panels_low']) && $_POST['panels_low'] == 2): ?>
				...
				<?php if(isset($_POST['panels_medium']) && $_POST['panels_medium'] == 2): ?>
				...
				<?php if(isset($_POST['panels_high']) && $_POST['panels_high'] == 2): ?>
				...
				<?php if(isset($_POST['panels_full']) && $_POST['panels_full'] == 2): ?>
			...
			<div id="filter_panels_dimensions" class="filter_form_content">
				...
				<select name="panels_length" onchange="this.form.submit()">
					...
					<?php foreach ($length_list as $length) :?>
						...
						<?php if(isset($_POST['panels_length']) && $_POST['panels_length'] == $length): ?>
				...
				<div id="filter_panels_width_dropdown" class="filter_form_dropdown">Width<br>
					...
					<select name="panels_width" onchange="this.form.submit()">
						...
						<?php foreach ($width_list as $width) :?>
							...
							<?php if(isset($_POST['panels_width']) && $_POST['panels_width'] == $width): ?>
				...
				<div id="filter_panels_thickness_dropdown" class="filter_form_dropdown">Thickness<br>
					<select name="panels_thickness" onchange="this.form.submit()">
						...
						<?php foreach ($thickness_list as $thickness) :?>
							...
							<?php if(isset($_POST['panels_thickness']) && $_POST['panels_thickness'] == $thickness): ?>
			...
			<div id="filter_panels_performance" class="filter_form_content">
				<div id="filter_panels_absorption_class">Absorption Class<br>
					<select name="panels_absorption_class">
						...
						<?php if(isset($_POST['panels_absorption_class']) && $_POST['panels_absorption_class'] == "A"): ?>
							<option value="A" selected>A</option>
						<?php else: ?>
							<option value="A">A</option>
						<?php endif; ?>

						<?php if(isset($_POST['panels_absorption_class']) && $_POST['panels_absorption_class'] == "B"): ?>
							<option value="B" selected>B</option>
						<?php else: ?>
							<option value="B">B</option>
						<?php endif; ?>

						<?php if(isset($_POST['panels_absorption_class']) && $_POST['panels_absorption_class'] == "C"): ?>
							<option value="C" selected>C</option>
						<?php else: ?>
							<option value="C">C</option>
						<?php endif; ?>

						<?php if(isset($_POST['panels_absorption_class']) && $_POST['panels_absorption_class'] == "D"): ?>
							<option value="D" selected>D</option>
						<?php else: ?>
							<option value="D">D</option>
						<?php endif; ?>

						<?php if(isset($_POST['panels_absorption_class']) && $_POST['panels_absorption_class'] == "E"): ?>
			...
			<div id="filter_panels_fixing_type" class="filter_form_content">
				...
				<?php if(isset($_POST['panels_15mm']) && $_POST['panels_15mm'] == 2): ?>
				...
				<?php if(isset($_POST['panels_24mm']) && $_POST['panels_24mm'] == 2): ?>
				...
				<?php if(isset($_POST['panels_clip_in']) && $_POST['panels_clip_in'] == 2): ?>
				...
				<?php if(isset($_POST['panels_screwed']) && $_POST['panels_screwed'] == 2): ?>
				...
				<?php if(isset($_POST['panels_glued']) && $_POST['panels_glued'] == 2): ?>
				...
				<?php if(isset($_POST['panels_adhesive']) && $_POST['panels_adhesive'] == 2): ?>
			...
			<div id="filter_panels_installation" class="filter_form_content">
				...
				<?php if(isset($_POST['panels_wall']) && $_POST['panels_wall'] == 2): ?>
				...
				<?php if(isset($_POST['panels_ceiling']) && $_POST['panels_ceiling'] == 2): ?>
				...
				<?php if(isset($_POST['panels_floor']) && $_POST['panels_floor'] == 2): ?>
				...
				<?php if(isset($_POST['panels_corner']) && $_POST['panels_corner'] == 2): ?>
				...
				<?php if(isset($_POST['panels_vas']) && $_POST['panels_vas'] == 2): ?>
			...
			<div id="filter_panels_edges" class="filter_form_content">
				...
				<?php if(isset($_POST['panels_leveled']) && $_POST['panels_leveled'] == 2): ?>
				...
				<?php if(isset($_POST['panels_angled']) && $_POST['panels_angled'] == 2): ?>
			...
			<div id="filter_panels_material" class="filter_form_content">
				...
				<?php if(isset($_POST['panels_wood']) && $_POST['panels_wood'] == 2): ?>
				...
				<?php if(isset($_POST['panels_fabric']) && $_POST['panels_fabric'] == 2): ?>
				...
				<?php if(isset($_POST['panels_metal']) && $_POST['panels_metal'] == 2): ?>
				...
				<?php if(isset($_POST['panels_polystyrene']) && $_POST['panels_polystyrene'] == 2): ?>
				...
				<?php if(isset($_POST['panels_foam']) && $_POST['panels_foam'] == 2): ?>
			...
			<div id="filter_panels_wood_color" class="filter_form_content">
				...
				<?php if(isset($_POST['panels_wood_wenge']) && $_POST['panels_wood_wenge'] == 2): ?>
				...
				<?php if(isset($_POST['panels_wood_m_cherry']) && $_POST['panels_wood_m_cherry'] == 2): ?>
				...
				<?php if(isset($_POST['panels_wood_m_light_brown']) && $_POST['panels_wood_m_light_brown'] == 2): ?>
				...
				<?php if(isset($_POST['panels_wood_m_nordik']) && $_POST['panels_wood_m_nordik'] == 2): ?>
				...
				<?php if(isset($_POST['panels_wood_m_wenge']) && $_POST['panels_wood_m_wenge'] == 2): ?>
				...
				<?php if(isset($_POST['panels_wood_m_ash_wood']) && $_POST['panels_wood_m_ash_wood'] == 2): ?>
				...
				<?php if(isset($_POST['panels_wood_m_walnut']) && $_POST['panels_wood_m_walnut'] == 2): ?>
			...
			<div id="filter_panels_fabric_color" class="filter_form_content">
				...
				<?php if(isset($_POST['panels_fabric_black']) && $_POST['panels_fabric_black'] == 2): ?>
				...
				<?php if(isset($_POST['panels_fabric_grey']) && $_POST['panels_fabric_grey'] == 2): ?>
				...
				<?php if(isset($_POST['panels_fabric_bordeaux']) && $_POST['panels_fabric_bordeaux'] == 2): ?>
				...
				<?php if(isset($_POST['panels_fabric_beige']) && $_POST['panels_fabric_beige'] == 2): ?>
				...
				<?php if(isset($_POST['panels_fabric_natural_white']) && $_POST['panels_fabric_natural_white'] == 2): ?>
				...
				<?php if(isset($_POST['panels_fabric_brown']) && $_POST['panels_fabric_brown'] == 2): ?>
				...
				<?php if(isset($_POST['panels_fabric_blue']) && $_POST['panels_fabric_blue'] == 2): ?>
				...
				<?php if(isset($_POST['panels_fabric_orange']) && $_POST['panels_fabric_orange'] == 2): ?>
			...
			<div id="filter_panels_foam_type" class="filter_form_content">
				...
				<?php if(isset($_POST['panels_foam_m1']) && $_POST['panels_foam_m1'] == 2): ?>
				...
				<?php if(isset($_POST['panels_foam_recycled']) && $_POST['panels_foam_recycled'] == 2): ?>
				...
				<?php if(isset($_POST['panels_foam_tech']) && $_POST['panels_foam_tech'] == 2): ?>
				...
				<?php if(isset($_POST['panels_foam_quash']) && $_POST['panels_foam_quash'] == 2): ?>
...
<div id="filter_hidden_field"><?php echo (isset($_POST['category_button']) ? $_POST['category_button'] : ''); ?></div>