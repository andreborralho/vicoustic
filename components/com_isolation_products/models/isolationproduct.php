 ...
 */
class Isolation_productsModelIsolationproduct extends JModelForm
{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_isolation_products.isolationproduct', 'isolationproduct', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
