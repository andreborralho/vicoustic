<?php
  ...
  abstract class AntivibraticsHelper {
	...
	public static function renderSimilarProductImage($product) {
	  $html_output = '<a class="product_similar_link" href="' .  JRoute::_('index.php?option=com_antivibratics&view=antivibratic&id=' . (int)$product->id) . '" ';
	  if($product->photo_150px) {
