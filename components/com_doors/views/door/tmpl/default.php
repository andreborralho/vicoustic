		...
		<section id="doors_fields_list" class="products_fields_list">
			...
			<div class="product_technical_info">
				...
				<table class="door_options_table">
					...
					<tbody>
					<?php
						echo PanelsHelper::renderDoorOptionCell($this->item->keylock, JText::_('KEYLOCK'), $this->item->keylock_ref, $this->item->keylock_msrp, JText::_('EURO'));
						echo PanelsHelper::renderDoorOptionCell($this->item->antipanic_bar, JText::_('ANTIPANIC_BAR'), $this->item->antipanic_bar_ref, $this->item->antipanic_bar_msrp, JText::_('EURO'));
						echo PanelsHelper::renderDoorOptionCell(($this->item->keylock && $this->item->antipanic_bar), JText::_('KEYLOCK_ANTIPANICBAR'), $this->item->keylock_antipanicbar_ref, $this->item->keylock_antipanicbar_msrp, JText::_('EURO'));
						echo PanelsHelper::renderDoorOptionCell($this->item->circular_double_window, JText::_('CIRCULAR_DOUBLE_WINDOW_30'), $this->item->circular_double_window_ref, $this->item->circular_double_window_msrp, JText::_('EURO'));
						echo PanelsHelper::renderDoorOptionCell($this->item->without_floor_frame, JText::_('WITHOUT_FLOOR_FRAME'), $this->item->without_floor_frame_ref, $this->item->without_floor_frame_msrp, JText::_('EURO'));
						echo PanelsHelper::renderDoorOptionCell($this->item->autoclose_system, JText::_('AUTOCLOSE_SYSTEM'), $this->item->autoclose_system_ref, $this->item->autoclose_system_msrp, JText::_('EURO'));
					?>
					</tbody>
				</table>
			</div>
			...
			<?php if (isset($this->similar) && sizeof($this->similar) > 1) { ?>
				<table class="product_similar_table">
					...
					<tr>
						...
						<th><?php echo JText::_('NO_OF_DOORS'); ?></th>
						<th><?php echo JText::_('DIMENSIONS'); ?></th>
						<th><?php echo JText::_('GROSS_WEIGHT'); ?></th>
						<th><?php echo JText::_('FINISH'); ?></th>
						<th><?php echo JText::_('RW'); ?></th>
					</tr>
					</thead>
