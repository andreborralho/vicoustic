...
class BlanketsViewBlanket extends JView {
    ...
    public function display($tpl = null) {
        ...
        $this->params = $app->getParams('com_blankets');
        ...
        if($this->_layout == 'edit') {
            ...
            $authorised = $user->authorise('core.create', 'com_blankets');
	...
	protected function _prepareDocument()
	{
		...
		if($menu)
		{
			...
			$this->params->def('page_heading', JText::_('com_blankets_DEFAULT_PAGE_TITLE'));
		}
