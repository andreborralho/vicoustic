...
if ($components)
{
	...
	foreach ($components as &$component)
	{
		...
		{
			if($component->text != "Isolation Products" && $component->text != "Product Filter" && $component->text != "Resources" && 
				$component->text != "blank-component" && $component->text != "Joomla! Update"){
				$menu->addChild(new JMenuNode($component->text, $component->link, $component->img));
			}
		}
	}
	
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_MB'), '#', 'class:slideshow'), true);	
	
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_HOME_MB'), 'index.php?option=com_modules&view=module&task=[module].edit&id=142', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_CONTROL_ROOM'), 'index.php?option=com_modules&view=module&task=[module].edit&id=162', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_VOCAL_BOOTH'), 'index.php?option=com_modules&view=module&task=[module].edit&id=163', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_RECORDING_ROOM'), 'index.php?option=com_modules&view=module&task=[module].edit&id=164', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_LIVE_REHEARSAL_ROOM'), 'index.php?option=com_modules&view=module&task=[module].edit&id=165', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_HOME_STUDIO'), 'index.php?option=com_modules&view=module&task=[module].edit&id=166', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_RD_DEPARTMENT'), 'index.php?option=com_modules&view=module&task=[module].edit&id=167', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_PROJECT_DEPARTMENT'), 'index.php?option=com_modules&view=module&task=[module].edit&id=168', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_VIP'), 'index.php?option=com_modules&view=module&task=[module].edit&id=169', 'class:slideshow'));
	$menu->getParent();
	
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_HF'), '#', 'class:slideshow'), true);	
	
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_HOME_HF'), 'index.php?option=com_modules&view=module&task=[module].edit&id=141', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_HIFI_ROOM'), 'index.php?option=com_modules&view=module&task=[module].edit&id=154', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_HOME_THEATER'), 'index.php?option=com_modules&view=module&task=[module].edit&id=157', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_LIVING_ROOM'), 'index.php?option=com_modules&view=module&task=[module].edit&id=156', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_HIFI_SHOWS'), 'index.php?option=com_modules&view=module&task=[module].edit&id=155', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_RD_DEPARTMENT'), 'index.php?option=com_modules&view=module&task=[module].edit&id=158', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_PROJECT_DEPARTMENT'), 'index.php?option=com_modules&view=module&task=[module].edit&id=159', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_VITUNE'), 'index.php?option=com_modules&view=module&task=[module].edit&id=161', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_VIP'), 'index.php?option=com_modules&view=module&task=[module].edit&id=160', 'class:slideshow'));
	$menu->getParent();
	
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_BC'), '#', 'class:slideshow'), true);	
	
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_HOME_BC'), 'index.php?option=com_modules&view=module&task=[module].edit&id=97', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_EDUCATION'), 'index.php?option=com_modules&view=module&task=[module].edit&id=107', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_HEALTHCARE'), 'index.php?option=com_modules&view=module&task=[module].edit&id=108', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_TRANSPORTS'), 'index.php?option=com_modules&view=module&task=[module].edit&id=109', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_RETAIL_LEISURE'), 'index.php?option=com_modules&view=module&task=[module].edit&id=111', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_OFFICE'), 'index.php?option=com_modules&view=module&task=[module].edit&id=110', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_HIFI_HOME_CINEMA'), 'index.php?option=com_modules&view=module&task=[module].edit&id=98', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_HOUSE_WORSHIP'), 'index.php?option=com_modules&view=module&task=[module].edit&id=112', 'class:slideshow'));
	$menu->addChild(new JMenuNode(JText::_('MOD_MENU_SLIDESHOW_RESEARCH'), 'index.php?option=com_modules&view=module&task=[module].edit&id=113', 'class:slideshow'));
	$menu->getParent();
