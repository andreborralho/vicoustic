...
<form action="<?php echo JRoute::_('index.php?option=com_acoustic_solutions&view=acoustics_mb_options'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_ACOUSTIC_SOLUTIONS_ACOUSTICS_MB_IMAGE', 'a.image', $listDirn, $listOrder); ?>
				</th>				

				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_ACOUSTIC_SOLUTIONS_ACOUSTICS_MB_SOLUTION_ID', 'a.solution_id', $listDirn, $listOrder); ?>
				</th>
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
                ...
                <?php if (isset($this->items[0]->state)) { ?>
				    <td class="center">
					    <?php echo JHtml::_('jgrid.published', $item->state, $i, 'acoustics_mb_options.', $canChange, 'cb'); ?>
				    </td>
                <?php } ?>

                <td>
                <?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_acoustic_solutions&task=acoustic_mb_option.edit&id='.(int) $item->id); ?>">
				...
				<td>
					<img alt="Image" src="../<?php echo $item->image; ?>" height="60px" width="80px">
				</td>

				<td>
					<?php echo $item->option_ref; ?>
				</td>
