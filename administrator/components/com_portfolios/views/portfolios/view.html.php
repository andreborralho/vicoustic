...
class PortfoliosViewPortfolios extends JView
{
	...
	public function display($tpl = null)
	{
        ...
        PortfoliosHelper::addSubmenu($view);
	...
	{
		require_once JPATH_COMPONENT.'/helpers/portfolios.php';

		$state	= $this->get('State');
		$canDo	= PortfoliosHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_PORTFOLIOS_TITLE_PORTFOLIOS'), 'portfolios.png');
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_portfolios');
		}
