	...
	<?php
		if ($app->isAdmin()) {
			...
			if ($user->usertype == 'Super Administrator') {
				...
				if ($pluginid) {
					echo '<em>' . html_entity_decode(JText::_('SRC_SEE_THE_PLUGIN_FOR_SETTINGS'), ENT_COMPAT, 'UTF-8') . ' (<a href="' . JURI::base(true) . '/index.php?option=com_plugins&view=plugin&client=site&task=edit&cid[]=' . $pluginid . '" target="_blank">' . JText::_('NN_SETTINGS_EDITOR_BUTTON') . '</a>)</em>';
				}
			}
		}
