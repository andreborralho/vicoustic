...
?><meta name="author" content="Andre Borralho, andrefilipe_one@hotmail.com">
<meta name="google-site-verification" content="JDhysOFmF7IG7bvmkxRgWJXKlDCvKwAbwPWCYumesj8" />
...
<?php 
	...
	if(($tokens[0] == "" || $last_url == "") && !$is_search){ ?>
		<div id="portal_wallpaper">
			<?php if($s5_pos_bottom_menu){ ?>
				<div id="s5_bottom_menu_wrap">
					<div id="portal_logo_container">
						<img id="portal_logo" alt="Vicoustic" src="images/logohome.png">
					</div>
					<h1 id="home_message">
						Acoustic Treatment and Insulation
						<h2 id="home_message_pt">
	...
	<?php }
		...
		<div id="s5_social_icons">
			<a href="http://www.facebook.com/wavewood" id="facebook" target="_blank" title="Facebook"></a>
			<a href="http://twitter.com/Vicoustic" id="twitter" target="_blank" title="Follow us on Twitter"></a>
			
			<a href="http://www.linkedin.com/company/3069963" id="linkedin" target="_blank" title="LinkedIn"></a>
			<a href="http://www.youtube.com/user/Vicoustic1" id="youtube" target="_blank" title="Youtube"></a>
			<a href="http://vimeo.com/channels/457364" id="vimeo" target="_blank" title="Vimeo"></a>
		</div>
					...
					<div id="s5_header_wrap">
						...
						<?php if($s5_pos_banner == "published") { ?>
							<div id="s5_banner" style="padding-left:<?php echo $s5_logo_width + 10 ?>px">
								...
								<?php if (($s5_font_resizer == "yes") || ($s5_register  != "") || ($s5_login  != "")) { ?>
					...
					<?php if($s5_pos_footer == "published") { ?>
						<div id="s5_footer_module">
							...
							<?php if (($s5_linked_in  != "") || ($s5_rss  != "") || ($s5_twitter  != "") || ($s5_facebook  != "") || ($s5_google  != "")) { ?>
								<div id="s5_social_networks_wrap">
									<div id="s5_social_networks_wrap_inner">
	...
	<script>
	  ...
	  ga('create', 'UA-43694480-1', 'vicoustic.com');
	  ga('send', 'pageview');
